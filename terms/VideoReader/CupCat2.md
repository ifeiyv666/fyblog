...
概述
《茶杯虎浏览器用户隐私政策》（以下简称“本政策”）适用于（以下简称“我们”）提供的茶杯虎浏览器应用及相关产品和服务（以下简称“本产品”），我们作为本产品的运营者，深知个人信息对您的重要性，我们将按照法律法规的规定（GB/T35273-2017《个人信息安全规范》），保护您的个人信息及个人敏感信息安全。我们制定本政策并特别提示：希望您在使用本产品及相关服务前仔细阅读并理解本隐私政策，以便做出适当的选择。
本政策属于《茶杯虎浏览器用户协议》，为其不可分割的一部分。
...
2.注册、认证、登录本产品和相关服务
（1）当您注册、登录本产品及相关服务时，您通过手机号创建账号，我们将通过发送短信验证码来验证您的身份是否有效，并且您可完善相关的网络身份识别信息（如密码），收集这些信息是为了帮助您完成注册。手机号码属于敏感信息，收集此类信息是为了满足相关法律法规的网络实名制要求。若您不提供这类信息，您可能无法正常使用我们的服务。您还可根据自身需求选择填写性别、生日、签名等信息完善您的个人信息。
（2）您也可以使用第三方帐号（如微信、QQ）登录本产品。您此时将授权我们获取您在第三方平台注册的公开信息(头像、昵称等)，并在您同意本隐私政策后将您的第三方账号与您的本产品账户绑定，使您可以通过第三方账号直接登录并使用本产品和相关服务。
您未登录本产品并不会影响您使用本产品搜索、浏览功能，但可能会影响您发布作品、点赞、投稿等业务功能。您提供的上述信息，将在您使用本服务期间持续授权我们使用。
3.为您提供内容信息发布等功能或服务
您主动发布内容、评论时，我们将收集您所发布的内容信息，展示您的签名、头像、发布的信息内容等。
（1）您在发布图片、音视频等内容时，我们会请求您授权相机、照片、麦克风等敏感权限。如果拒绝提供授权，您将无法使用此功能，但不影响您正常使用本产品的其他功能。
（2）当您发布内容时选择带有地理位置的功能时，我们会请求您授权地理位置这一敏感权限，并收集与本服务相关的位置信息，这些技术包括IP地址、GPS等传感器技术。您如果拒绝授权提供，将无法使用此功能，但不影响您正常使用本产品的其他功能。
4.为您提供互动功能或服务
（1）您主动关注您感兴趣的账号时，我们会收集您关注的账号，并向您展示您关注账号发布内容。
5.为您提供搜索服务
您使用本产品的搜索服务时，我们会收集您的搜索关键字信息、日志记录等。为了提供高效的搜索服务，部分前述信息会暂时存储在您的本地存储设备之中，并可向您展示搜索结果内容、搜索历史记录。
6.开展营销活动
当您选择参加我们举办的有关营销活动时，根据活动需要您可提供姓名、通信地址、联系方式等信息。这些信息中可能包含个人敏感信息（如个人电话号码等），是您收到礼品所必要的，如果您拒绝提供这些信息，我们将可能无法向您发放礼品。
7.保障产品、服务及用户使用安全
为帮助我们更好地了解本产品及相关服务的运行情况，以便确保运行与提供服务的安全，我们可能记录网络日志信息，以及使用软件及相关服务的频率、崩溃数据、总体安装、使用情况、性能数据等信息。
8.广告服务优化
为了保证良好的用户体验，向您提供众多免费、优质的服务，尽可能地减少与您无关的广告对您造成的侵扰，我们会收集的有关您位置的信息。
9.第三方SDK接入服务所需开通的权限
...
​二、对Cookie和同类技术的使用
Cookie和同类技术是互联网中的通用常用技术。当您使用本产品软件及相关服务时，我们可能会使用相关技术向您的设备发送一个或多个Cookie或匿名标识符，以收集和存储您访问、使用本产品时的信息。我们使用Cookie和同类技术主要为了实现以下功能或服务：
...
​四、我们如何共享、转让、公开披露个人信息
（一）共享
我们不会与上海量码网络科技以外的任何公司、组织和个人分享您的个人信息， 但以下情况除外：
1.在获取明确同意的情况下共享：获得您的明确同意后，我们会与其他方共享您的个人信息。
2.我们可能会根据法律法规规定，或按政府主管部门的强制性要求， 对外共享您的个人信息。
3.与上海量码网络科技公司共享：我们只会共享必要的个人信息，且受本政策中所声明目的的约束。如要改变个人信息的处理目的，将再次征求您的授权同意。
...
（二）投诉举报
如果您认为您的个人信息权利可能受到侵害，或者发现侵害个人信息权利的线索，您可以用过电子邮件：cuptiger@qq.com 进行投诉或举报。我们核查后会在15日内反馈您的投诉与举报。
 
（三）访问隐私政策
您可以点击【我的-关于】进页查看本隐私政策的全部内容。
 
（四）停止运营向您告知权利
如我们停止运营，我们将及时停止收集您个人信息的活动，将停止运营的通知以逐一通过电子邮件、信函、电话、推送通知、公告等形式通知您，并对所持有的您的个人信息进行删除或匿名化处理。
...
​九、适用范围
本隐私权政策适用于由上海量码网络科技有限公司及其关联方提供的所有服务，包括本产品之客户端、网站等，不适用于有单独的隐私权政策且未纳入本隐私权政策的第三方产品或服务。
本隐私权政策不适用于：
...
第三方SDK名称：Bugly
用途：用于应用升级
收集的个人信息类型：网络设备硬件地址、唯一设备识别码、设备信息、网络信息
SDK隐私政策链接：https://www.tencent.com/zh-cn/privacy-policy.html

第三方SDK名称：腾讯广告SDK
用途：广告服务
收集的个人信息类型：唯一设备识别码、设备信息、网络信息、位置信息
SDK隐私政策链接：https://www.tencent.com/zh-cn/privacy-policy.html

第三方SDK名称：穿山甲广告SDK
用途：广告服务
收集的个人信息类型：唯一设备识别码、设备信息、网络信息、位置信息
SDK隐私政策链接：https://ad.oceanengine.com/union/media/privacy

第三方SDK名称：百度广告SDK
用途：广告服务
收集的个人信息类型：唯一设备识别码、设备信息、网络信息、位置信息
SDK隐私政策链接：https://union.baidu.com/bqt#/policies

第三方SDK名称：OPPO广告SDK
用途：广告服务
收集的个人信息类型：唯一设备识别码、设备信息、网络信息、位置信息
SDK隐私政策链接：https://www.oppo.com/cn/service/help/640?id=640&name=%E6%9C%8D%E5%8A%A1%E6%94%BF%E7%AD%96&hdscreen=1


十一、如何联系我们
(a) 如您对本隐私政策或您个人信息的相关事宜有任何问题、意见或建议，请通过发送邮件至 cuptiger@qq.com 与我们联系。
...
（二）本“隐私政策”相关词语释义：
	1.本产品之及相关服务是指公司及其关联方通过合法拥有并运营的、标注名称为本产品客户端应用程序以及本产品官方网站（https://cuptiger.com/），向您提供的产品与服务，包括但不限内容发布、浏览及推荐等功能。
